...
// <DobConstraint, LocalDate>: DobConstraint là annotation tùy chỉnh mà validator này sẽ xử lý, và LocalDate là kiểu dữ
// liệu mà annotation này sẽ được áp dụng (trong trường hợp này là ngày tháng năm sinh).
